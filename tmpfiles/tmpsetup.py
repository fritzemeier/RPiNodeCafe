...
replacements = {"name of Raspberry Pi account":"<<name of Raspberry Pi account>>", "path":"<<path>>", "phone number from which you will be sending commands -- including area code":"<<phone number from which you will be sending commands -- including area code>>", "email which Pi uses to receive texts":"<<email which Pi uses to receive texts>>", "password of email address":"<<password of email address>>", "IP of NodeJS server":"<<IP of NodeJS server>>", "port of NodeJS server HTTP connections":"<<port of NodeJS server HTTP connetions>>", "port of NodeJS server HTTPS connections":"<<port of NodeJS server HTTPS connections>>", "name of SSID":"<<name of SSID>>", "password to SSID":"<<password to SSID>>","Sonoff WiFi switch device name":"<<Sonoff WiFi switch device name>>"}
pattern = '<<([^>]*)>>'
